  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>레시피 분류</Text>
        <View style={{ width: 40 }} />
      </View>
      <View style={styles.placeholder}>
        <Text style={styles.placeholderEmoji}>📂</Text>
        <Text style={styles.placeholderTitle}>레시피 분류</Text>
        <Text style={styles.placeholderSub}>테마별·재료별 분류 기능이 준비 중입니다. (추후 제작)</Text>
      </View>
    </SafeAreaView>
  );
}
